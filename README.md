# Krishna Family Garden Restaurant — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-krishna-family-garden-restaurant/
- **Repo:** `shreekantha3/sindagi-krishna-family-garden-restaurant` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-krishna-family-garden-restaurant/'` for GitHub Pages project-site hosting.
